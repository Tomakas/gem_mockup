<template>
  <v-container fluid class="sales-list">
    ...
    >
      ...
      <template #cell-amount="{ item }"><span v-if="viewMode === 'receipts'">{{ formatCurrency(item.amount) }}</span></template>
      <template #cell-itemPrice="{ item }"><span v-if="viewMode === 'products'">{{ formatCurrency(item.itemPrice) }}</span></template>
      <template #cell-total="{ item }"><span v-if="viewMode === 'products'">{{ formatCurrency(item.total) }}</span></template>
      <template #cell-tax="{ item }"><span v-if="viewMode === 'products'">{{ item.tax }} %</span></template>
