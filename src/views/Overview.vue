        ...
        <v-card flat class="pa-2 h-100 d-flex flex-column justify-center">
          <div class="d-flex align-center flex-wrap justify-center">
            ...
            <div class="d-flex align-center">
              ...
              ></v-btn>
              <div
                class="text-subtitle-1 mx- text-center"
              ...
              <v-btn
                ...
                variant="text"
                @click="navigatePeriod(1)"
                :disabled="isNextDisabled || selectedPeriod === 'custom'"
              ></v-btn>
            </div>
          </div>
        </v-card>
    ...
    <v-row class="mt-4">
      <v-col cols="12" lg="6" md="8" sm="12">
        <v-card class="pa-4" flat>
          ...
          <v-card-text>
            <div
              class="chart-placeholder primary-bg"
              style="height: 300px"
            ></div>

            <p class="text-center mt-2 text-caption">
              Zde bude kombinovaný graf prodejů a účtenek
            </p>
          </v-card-text>
        </v-card>
      </v-col>
      <v-col cols="12" lg="3" md="4" sm="12">
        <v-card class="pa-4" flat>
          ...
          <v-card-text>
            <div
              class="chart-placeholder secondary-bg"
              style="height: 300px; border-radius: 50%"
            ></div>
            <p class="text-center mt-2 text-caption">
              Zde bude kruhový graf typů plateb
            </p>
          </v-card-text>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" lg="3" md="6" sm="12">
        <v-card class="pa-4" flat>
          <v-card-title class="text-h6">Kategorie prodeje</v-card-title>

          <v-card-text>
            <div class="chart-placeholder info-bg" style="height: 300px"></div>
            <p class="text-center mt-2 text-caption">
              Zde bude treemap graf kategorií
            </p>
          </v-card-text>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" lg="4" md="6" sm="12">
        <v-card class="pa-4" flat style="minheight: 10px">
...
<script setup>
  ...
  { username: 'Petr.Kovac', totalSales: 810.50, totalReceipts: 4, hours: 3 },

    { username: 'David', totalSales: 200.00, totalReceipts: 1, hours: 6 },
